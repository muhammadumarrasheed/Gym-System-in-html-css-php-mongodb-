...
$var = $_GET['updateid'];
$trainer = $MRFitness->trainer;
$command = $trainer->find(array('trainerEmail' => $var));
...
if($trainer->updateOne(
    ['trainerEmail' => $email], 
    ['$set'=> ['trainerEmail' => $email, 'trainername' => $name, 'password' => $password, 'phoneNum' => $phone, 
