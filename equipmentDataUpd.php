...
$name = $_POST['eqname'];
if($MRFitness->equipment->updateOne(
    ['eqid' => $id], 
    ['$set'=> ['eqid' => $id,'equipmentname' => $name]]
)){
    ...
    <div class="container my-5">
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter your name" name="eqname" autocomplete="off">
            </div>
