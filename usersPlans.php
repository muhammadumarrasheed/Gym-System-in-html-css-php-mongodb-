    ...
    <div class="container">
        ...
        <table class="table" style="width:50%">
            ...
            <tbody>
                ...
                $plan = $MRFitness->plan;
                $command = $plan->find();
                    foreach($command as $plans){
                        $userEmail = $plans['userEmail'];
                        $name = $plans['planname'];
                        echo '<tr>
                        <th scope="row">'.$plans['userEmail'].'</th>
                        <td>'.$name.'</td>
                        <td>
                     <button class = "btn btn-primary my-1"><a href="usersPlanUpdate.php?updateid='.$userEmail.'" class = "text-light">Update</a></button><br>
                 </td>
                    </tr>';
                }
                ?>
